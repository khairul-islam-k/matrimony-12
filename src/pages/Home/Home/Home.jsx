...
const Home = () => {
    ...
    return (
        <div className='pt-24'>
            ...
            <div
                data-aos="fade-up"
                className='bg-[url("assets/banner.png")] lg:min-w-[1150px] lg:min-h-[500px] bg-no-repeat bg-cover min-w-[300px] min-h-[130px] flex justify-center items-center rounded-xl'>
                <div>
